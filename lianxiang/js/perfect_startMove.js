	...
	//明星单品
	       $(function(){
                            $(".str-pic").find("ul").find("li").hover(function(){
      ...
      /*    
          $(function(){
            ...
            function tab(){
                ...
                oUl.animate({width: -770*iNow},function(){
                    if(iNow == aLi.size()-1){
                        iNow = 0;
                        oUl.css("left" )
                    }
...
$(function(){
    ...
    $(".dw2").click(function(){
        ...
        $(".days").find("div").find("ul").animate({left:lf+'px'},500);
    })
