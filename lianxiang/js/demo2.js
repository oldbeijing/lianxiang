...
//demo2 部分
$(function(){
    $(".right").find("ul").find("li").find("a").eq(1).click(function(){
        $(this).css("color", "red");
        $(".bb1").css("display", "none");
        $(".bb2").css("display", "block")
        $(".right ul").find("li").eq(0).find("a").css("color", "#000");
        $(".right ul").find("li").eq(2).find("a").css("color", "#000");
        $(this).parent().css("background","#fff").css("border-top","2px solid red");
        $(this).parent().siblings().css("background","#eee").css("border-top", "2px solid #eee");
        return false;
    });

    $(".right").find("ul").find("li").find("a").eq(2).click(function(){
        $(this).css("color", "red");
        $(".bb1").css("display", "none");
        $(".bb2").css("display", "none");
        $(".right ul").find("li").eq(0).find("a").css("color", "#000");
        $(".right ul").find("li").eq(1).find("a").css("color", "#000");
        $(this).parent().css("background","#fff").css("border-top","2px solid red");
        $(this).parent().siblings().css("background","#eee").css("border-top", "2px solid #eee");
        return false;
    })
...
/*
 ...
 $(function(){
    ...
    $("#m3").click(function(){
        ...
        $('#i1,#i2,#i4,#i5').css("display", "none")
    });
    $("#m4").click(function(){
        $(this).css("opacity", "1")
        $("#i4").css("display", "block");
        $('#i1,#i2,#i3,#i5').css("display", "none")
    });
    $("#m5").click(function(){
        $(this).css("opacity", "1")
        $("#i5").css("display", "block");
        $('#i1,#i2,#i3,#i4').css("display", "none")
    });
...
$(function(){
    ...
    $(".dw1").click(function(){
        ...
        $(".play ul ").animate({left:lf+'px'},300);
    })
